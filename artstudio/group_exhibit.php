...
<body>
    <div class="row">
        <h1 class="exhibit_h1">Group Exhibitions - India</h1>
        <hr class="hr_art">
        <div class="column">
            <div class="card">
                <div class="img no_g_one"></div>
                <div class="description no_g_one">
        ...
        <div class="column">
            <div class="card">
                <div class="img no_g_three"></div>
                <div class="description no_g_three">
                    <h1>Tre Cries</h1>
    ...
    <div class="row">
        <h1 class="exhibit_h1">Group Exhibitions - Other Countries</h1>
        <hr class="hr_art">
        <div class="column">
            <div class="card">
                <div class="img no_g_two"></div>
                <div class="description no_g_two">
        ...
        <div class="column">
            <div class="card">
                <div class="img no_g_four"></div>
                <div class="description no_g_four">
